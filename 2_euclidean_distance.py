...
from misc.helper import euclidean_distance, get_ground_truth
...
# 
            if corners is not None:
                distance += euclidean_distance(pred_points=corners, gt_points=gt_corners)
            
            total += 4

    avg_distance = (distance/total)

    print(f"{algorithm} Avg Distance: {avg_distance}")
