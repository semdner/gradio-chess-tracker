...
def record(frame, corners, matrix, board, squares):
    ...
    piece_square_mapping = assign_pieces_to_squares(homographed_frame, squares, piece_coordinates_mapping, piece_square_mapping)
...
def generate_image(board):
    svg_img = chess.svg.board(board, size=1000, colors={"square light": "#f0d9b5", "square dark": "#b58863"})
